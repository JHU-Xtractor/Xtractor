...
export declare type SpacerOverridesProps = {
    Spacer?: PrimitiveOverrideProps<ViewProps>;
    Divider?: PrimitiveOverrideProps<DividerProps>;
} & EscapeHatchProps;
export declare type SpacerProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: SpacerOverridesProps | undefined | null;
}>;
