...
export default function HeroLayout2(props) {
  ...
  const variants = [
    ...
    {
      overrides: {
        "Full stack": { color: "rgba(143,192,234,1)" },
        "Build full-stack web and mobile apps in hours. Easy to start, easy to scale":
          { color: "rgba(165,182,238,1)" },
        "AWS Amplify is a complete solution that lets frontend web and mobile developers easily build, ship, and host full-stack applications on AWS, with the flexibility to leverage the breadth of AWS services as use cases evolve. No cloud expertise needed.":
          { color: "rgba(143,164,234,1)" },
        "Main Body": {},
        Button: {},
        "Type Lock Up": {},
        HeroLayout2: { backgroundColor: "rgba(35,53,112,1)" },
      },
  ...
  return (
    <Flex
      ...
      backgroundColor="rgba(165,182,238,1)"
      display="flex"
